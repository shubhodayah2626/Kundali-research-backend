...
/**
 * Computes all 14 scores from manually-entered REAL planetary
 * positions (typed in directly from a verified AstroSage chart or
 * similar) -- no astronomical calculation, no PDF parsing. This
 * removes all astronomical approximation error since the positions
 * themselves are ground truth.
 */
