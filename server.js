...
const { calculateAllScoresFromManualPositions } = require('./scoring');
...
app.post('/api/kundali/generate', async (req, res) => {
  try {
    ...
    const { scores, scoringDetails } = calculateAllScoresFromManualPositions(planetaryPositions);
    ...
    new Kundali({
      ...
      location: location || {}, planetaryPositions, scores, scoringDetails
